...
public class DatabricksConfigHostCredsProvier implements MlflowHostCredsProvider {
  ...
  public DatabricksConfigHostCredsProvier(String profile) {
    this.profile = profile;
  }

  public DatabricksConfigHostCredsProvier() {
    this.profile = null;
  }
